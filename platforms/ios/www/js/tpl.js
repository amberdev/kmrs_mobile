...
function cartFooter(currency_code,is_omnivore_setup)
{
  var htm='';  
  
  htm+='<div class="wrapper">';
      htm+='<div class="field-wrapper">';
      if(is_omnivore_setup==2)
      {
      	htm+='<textarea name="order_notes" id="char_limit_fl" class="trn order_notes text-input text-input--underbar" placeholder="'+getTrans("Special Instructions",'special_instruction')+'"></textarea>';
      }
      else
      {
